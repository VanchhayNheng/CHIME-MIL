...
OUT=${WT}/results/results_loso_sa_stratified_genbio_20260421
LOGS=${WT}/results/logs_sa_stratified_${TS}
mkdir -p "${LOGS}" "${OUT}"
SCRIPT="${WT}/train_loso_sa_genbio.py"
COMMON="--val_split stratified --output_dir ${OUT}"
echo "OUT=${OUT}"
echo "LOGS=${LOGS}"
